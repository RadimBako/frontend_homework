...
const Errors = require("../api/errors/shoppinglist-app-error.js");
...
const logger = LoggerFactory.get("ShoppingListAppAbl");

class ShoppingListAppAbl {
  constructor() {
...
module.exports = new ShoppingListAppAbl();
